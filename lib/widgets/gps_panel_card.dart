...
class GpsStatsPanel extends StatelessWidget {
        ...
        return Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _getEmergencyColor(controller.currentEmergencyLevel).withValues(alpha: 0.3),
                width: 2,
              ),
              boxShadow: [
                BoxShadow(
  ...
  Widget _buildHeaderRow(GpsController controller) {
  ...
  Widget _buildStatsGrid(GpsController controller) {
    return Row(
      children: [
        Expanded(
  ...
  Widget _buildSOSPanel(GpsController controller) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
